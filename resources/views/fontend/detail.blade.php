						...
						<div class="action">
                            @if(Auth::check())
                              <form action="{{ route('cart.add', $product) }}" method="POST">
                                @csrf
                                <button class="add-to-cart btn btn-default" style="color: #fff; text-decoration: none;" type="submit">Thêm vào giỏ</button>
                                  
                              </form>
                                <button class="like btn btn-default" type="button"><span class="fa fa-heart"></span></button>      
                            @else
                                <button class="add-to-cart btn btn-default" type="submit">
                                    <a href="{{ route('login')}}" style="color: #fff; text-decoration: none;">Thêm vào giỏ</a>
                                </button>
                                <button class="like btn btn-default" type="button"><span class="fa fa-heart"></span></button>      
                            @endif
						</div>
